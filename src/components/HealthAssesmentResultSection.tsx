    ...
    return (
        <div className="w-full flex flex-col lg:flex-row space-y-4 lg:space-y-0 lg:space-x-6 my-8">
            ...
            <div className="flex-1 flex flex-col items-center border p-6 rounded shadow-lg">
                ...
                <p className="text-lg">Probability of being healthy: {healthProbability}%</p>
                <h3 className="text-2xl font-semibold mb-2 mt-4">Possible Diseases:</h3>
                {disease.suggestions.map((suggestion, index) => (
                    <div key={index}>
                        <h4 className="text-xl font-semibold mb-2">{suggestion.name}</h4>
                        <p className="text-lg">
